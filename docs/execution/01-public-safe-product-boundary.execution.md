# Execution: C0 - Scope, IP boundary, judging target
    ...
    - Current gate prompt: `docs/implementation-prompts/gate-c0.prompt.md`
    - Current todo prompt: `docs/implementation-prompts/todos/c0-t01-project-scope-and-ip-boundary.prompt.md`
