# Coding Prompt: C0-T01 - Project Scope and IP Boundary
...
- Define the project as Track 2 Video Captioning only.
- State that the system preserves one factual scene core and renders four required tones.
- Add conservative README gate status and roadmap language.
- Avoid private research, private repo paths, and unreleased architecture terms.
- Establish that future README updates require evidence from the current gate artifact.

## Concrete Artifact Requirement

Create or update a small public-safe scope artifact:

```text
docs/artifacts/c0-scope-boundary.md
```
...
```text
README.md, LICENSE optional, docs/README_GATE_POLICY.md optional, docs/artifacts/c0-scope-boundary.md
```
...
3. Read `docs/execution/01-public-safe-product-boundary.execution.md`.
...
10. suggested conventional commit: `docs(scope): define public boundary and gate policy`
